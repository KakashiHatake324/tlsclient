...
// tlsclientCanClose verifies that clients can also force a connection to close.
func tlsclientCanClose(t *testing.T) {
...
// tlsclientWriteShutdown tests that if the client shuts down the write
// side of their TCP connection, the server doesn't send a 400 Bad Request.
func tlsclientWriteShutdown(t *testing.T) {
