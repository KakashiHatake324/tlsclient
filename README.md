...
func main() {
	...
	// To use a custom ja3 
	// set your ja3 string as Client in clientHello 
	clientHello := tls.ClientHelloID{
		Client: "771,49196-49195-49188-49187-49162-49161-52393-49200-49199-49192-49191-49172-49171-52392-157-156-61-60-53-47-49160-49170-10,65281-0-23-13-5-13172-18-16-11-10,29-23-24-25,0",
	}

	// proxy url is optional
	client, err := tlsclient.NewClient(clientHello, jar, false, time.Duration(15), settings, "http://user:pass@ip:port")
