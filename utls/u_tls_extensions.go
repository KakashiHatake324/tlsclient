...
type FakeExtension17513 struct {
}

func (e *FakeExtension17513) writeToUConn(uc *UConn) error {
	return nil
}

func (e *FakeExtension17513) Len() int {
	// 4 + 5 bytes of message data
	return 9
}

func (e *FakeExtension17513) Read(b []byte) (int, error) {
	if len(b) < e.Len() {
		return 0, io.ErrShortBuffer
	}

	// declaring the id for our extension
	b[0] = byte(68)  // first part of id (0x44)
	b[1] = byte(105) // second part of id (0x69)
	// 0x4469 = 17513
