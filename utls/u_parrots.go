	...
	case HelloChromeModded:
		...
		return ClientHelloSpec{
			...
			Extensions: []TLSExtension{
				...
				&GenericExtension{Id: 0x4469, Data: []byte(chromeValue)},
				&GenericExtension{Id: 0x4500, Data: []byte(chromeValue)},
				&GenericExtension{Id: 0x4669, Data: []byte(chromeValue)},
				&GenericExtension{Id: 0x4769, Data: []byte(chromeValue)},
				&GenericExtension{Id: 0x4869, Data: []byte(chromeValue)},
				&GenericExtension{Id: 0x4969, Data: []byte(chromeValue)},
				&UtlsGREASEExtension{},
				&UtlsPaddingExtension{GetPaddingLen: BoringPaddingStyle},
			},
		}, nil
